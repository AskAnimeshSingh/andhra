...
class Pos extends Controller
{
  ...
  ;
        ...
        foreach($products as $key => $p) {
            ...
            $productss[$key]['price'] = $p->mainPrice;
...
//            $productss[$key]['grandTotal'] = $grandTotal;
    ...
    public function add_to_cart(Request $request)
    {
        ...
        $checkProductExixt = UserCart::where(['product_id' => $request->id , 'user_id' => Auth::user()->id, 'branch_id' => $request->branch_id, 'table_id' => $request->table_id])->count();

        $price = Price::where('branch_id',$request->branch_id)->where('product_id',$request->id)->first();
