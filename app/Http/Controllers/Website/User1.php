    ...
    public function submit(Request $request)
    {
        ...
        else
        {
            ...
            if($checkPhoneExists)
            {
                ...
                if($result)
                {
                    return response()->json(['status' => true , 'msg' => 'Otp send your register phone number' , 'location' =>  url('') .'/opt/'.$checkPhoneExists->id]);
                    exit;
                }
                else
                {
            ...
            else
            {
                ...
                if($result)
                {
                    return response()->json(['status' => true , 'msg' => 'Otp send your register phone number' , 'location' =>  url('') .'/opt/'.$data->id]);
                    exit;
                }
                else
                {
