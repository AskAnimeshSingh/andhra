...
class BrancheController extends Controller
{
    ...
    public function brancheAjaxList(Request $request)
    {
        ...
        foreach ($groups as $cate) {
            ...
            $data[] = array(
                ...
                $cate->address,
                $status,
                '<a href="' . route("admin.branch.edit", ["id" => $cate->id]) . '" class="editBranch btn btn-info btn-sm"  data-id="' . $cate->id . '" data-name="' . $cate->name . '" data-phone="' . $cate->phone . '" data-address="' . $cate->address . '" data-delivery_fee="' . $cate->delivery_fee . '"> <i class="fa fa-edit"></i></a> |
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'specialty_1_title' => 'required',
            'specialty_1_description' => 'required',
            'specialty_1_title_jpn' => 'required',
            'specialty_1_description_jpn' => 'required',
            "table_no"=> 'required',
            'specialty_2' => 'required',
            'specialty_2_title' => 'required',
            'specialty_2_description' => 'required',
            'specialty_2_title_jpn' => 'required',
            'specialty_2_description_jpn' => 'required',
        ...
        if ($validator->fails()) {
            ...
            $data->specialty_1_title = $request->specialty_1_title;
            $data->specialty_1_desccription = $request->specialty_1_description;
            $data->specialty_1_title_jpn = $request->specialty_1_title_jpn;
            $data->specialty_1_description_jpn = $request->specialty_1_description_jpn;
            $data->specialty_2_title = $request->specialty_2_title;
            $data->specialty_2_description = $request->specialty_2_description;
            $data->specialty_2_title_jpn = $request->specialty_2_title_jpn;
            $data->specialty_2_description_jpn = $request->specialty_2_description_jpn;
    ...
    public function order_details()
    {
        ...
        return view('admin.order.list', compact('delivery','branch'));
    }
