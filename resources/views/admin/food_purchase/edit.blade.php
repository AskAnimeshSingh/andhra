                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Food Purchase</h4>
                        </div>

                        <div class="card-body">
                            <form action="{{route('admin.food_purchase_update')}}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <table class="table table-bordered text-center">
                                        ...
                                        @foreach ($ingredient_stocks as $getData)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{\App\Helpers\MyHelper::getFoodStock($getData->product_id,$getData->branch_id)}}</td>
                                                <td><input type="text"
                                        ...
                                        <tr>
                                            <th colspan="3"></th>
                                            <th>Total Bill</th>
                                            <th>$ <span class="totalBill">{{$data->total_amnt}}</span></th>
                                        </tr>
                                        <tr>
                                            <th colspan="3"></th>
                                            <th>Paid</th>
                                            <th><input type="text" class="form-control text-center paidAmount"
                                                       name="totalPrice" value="{{$data->paid_amnt}}"
                                        ...
                                        <tr>
                                            ...
                                            <th class="d-none"><input type="text" class="form-control text-center due"
                                                                      name="duePrice" value="{{$data->due_amnt}}"
                                                                      placeholder="Price in USD"></th>
                                            <th>$ <span class="dueAmount">{{$data->due_amnt}}</span></th>
                                        </tr>
                                    </table>
                                </div>
