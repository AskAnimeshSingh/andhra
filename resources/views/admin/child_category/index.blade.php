...
<script>
  ...
  $("body").on("submit", ".store_cate", function(e) {
    ...
    $.ajax({
      url: "{{ route('admin.child_category.store') }}",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  var tables = $('#child_category').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      url: "{{route('admin.child_category_ajax_list')}}",
  ...
  $("body").on("submit", ".edit_cate", function(e) {
    ...
    fd.append('_token', "{{ csrf_token() }}");
    $.ajax({
      url: "{{ route('admin.child_category.update') }}",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  $("body").on("click", ".statusVerifiedClick", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "{{ route('admin.child_category.status') }}",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
  ...
  $("body").on("click", ".category-delete", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "{{ route('admin.child_category.destroy') }}",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
