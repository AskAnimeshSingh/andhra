            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header justify-content-between">
                        ...
                        <div class=""><a href="{{route('admin.chef')}}" class="btn btn-primary btn-sm">Add Chef</a></div>
                    </div>
                    <div class="card-body">
...
<script>
    var tables = $('#detail').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ route('admin.list_ajax.chef') }}",
                data: function(d) {
