            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.ingredient_purchase.new.store')}}" class="store_purchase"
                                  method="POST">
                                @csrf
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" name="items[]" id="items" multiple
                                        ...
                                        @foreach($ingredientsItem as $key => $getIngredients)
                                            <option value="{{$getIngredients->id}}">{{$getIngredients->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
@section('extra_js')
    ...
    <script>
        ...
        $('#branch').change(function () {
            ...
            const ingredientCount = {{count($ingredientsItem)}}
        ...
        $('#items,#branch').change(function () {
            ...
            const url = "{{route('admin.ingredient_purchase_items_show')}}"
            const body = {
                branchId, items,
                '_token': "{{ csrf_token() }}"
            }
