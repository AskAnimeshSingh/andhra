...
<head>
   ...
   <link rel="stylesheet" href="{{ asset('assets/website/css/newStyle.css')}}" type="text/css">
   <link rel="stylesheet" href="{{ asset('assets/website/css/newAyurveda.css')}}" type="text/css">
   <link rel="stylesheet" href="{{ asset('assets/website/css/newB1gallery.css')}}" type="text/css">
  ...
  -->
   ...
   @yield('extra_css')
   <style>
       @if( request()->is('reservation-index') || request()->is('reservation-page/*'))
...
<body id="top" style="background: #E7E5DC;">
   ...
   <script src="{{ asset('assets/website/js/newAyurveda.js')}}"></script>
   <script src="{{ asset('assets/website/js/newScript.js')}}"></script>
   <script src="{{ asset('assets/website/js/review.js')}}"></script>
   <script src="{{ asset('assets/website/js/branches.js')}}"></script>
   <script src="{{ asset('assets/website/js/awards.js')}}"></script>
   <script src="{{ asset('assets/website/js/newB1gallery.js')}}"></script>
