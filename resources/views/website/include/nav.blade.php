  ...
  <div class="container  ">
    @if(request()->is('/') == "/")
      <a href="{{ route('website.dashboard') }}" class="logo  ">
        <img src="{{ asset('assets/website/indexImages/changed_logo.png') }}" alt="Andhra Dining Logo" width="150" height="150" class="logo-img start">
      </a>
    @else
      <a href="{{ route('website.dashboard') }}" class="logo  ">
        <img src="{{ asset('assets/website/indexImages/changed_logo.png') }}" alt="Andhra Dining Logo" width="150" height="150" class="logo-img start">
  ...
  <ul class="navbar-list">
    ...
    <div class="flag lg:flex" style="margin: 0 20px;">
      <ul class="navbar-list" style="gap:5px">
        <li class="navbar-item">
          <a href="{{ route('locale.switch', 'en') }}" class="navbar-link hover-underline md:menu-color text-black">en</a>
        </li>
        <li class="navbar-item">
          <span class="navbar-link md:menu-color">|</span>
        </li>
        <li class="navbar-item">
          <a href="{{ route('locale.switch', 'ja') }}" class="navbar-link hover-underline md:menu-color text-black">日本語</a>
        </li>
      </ul>
    </div>
