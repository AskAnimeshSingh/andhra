@extends('website.layout.layoutheader')
@section('extra_css')
...
<!-- 
                                                ...
                                                <li class="nav-item">
                                                    <button
                                                        ...
                                                        <img src="{{ url($item->cate_img) }}" alt=""
                                                            style="width:40px;height: 40px;border-radius: 50%;"
                                                            class="me-4   object-cover">{{ $item->cate_name }}</button>
                                                </li>
                                            @endforeach
                                        </ul>
                                        ...
                                        <!-- change badshah -->
                                         ...
                                         {{-- <ul class="nav nav-pills mb-3 nav-category" id="pills-tab">
      <li class="nav-item">
        <button class="nav-link catg-link active d-flex align-items-center flex-wrap rounded-pill px-4 get_menu1" id="pills-all" data-bs-toggle="pill" data-bs-target="#all" type="button">
            <img src="{{ asset('assets/website/images/1.webp') }}" alt="" class="h-10 w-10 sm:h-20 sm:w-20 rounded-full  aspect-square me-4 ">
            All
        </button>
    </li>
    @foreach ($category as $item)
        <li class="nav-item">
            <button class="nav-link catg-link d-flex align-items-center rounded-pill px-4 get_menu flex-wrap" data-id="{{ $item->id }}" id="pills-all" data-bs-toggle="pill" data-bs-target="#all">
                <img src="{{ url($item->cate_img) }}" alt="" class="h-10 w-10 sm:h-20 sm:w-20 rounded-full aspect-square me-4">
                {{ $item->cate_name }}
            </button>
        </li>
    @endforeach
...
<div class="w-full max-w-full overflow-x-auto cursor-pointer whitespace-nowrap scrollbar-thin  scrollbar-track-gray-100 px-4 py-2 smooth-scroll">
  <div class="flex gap-4 nav-category" id="pills-tab">
    ...
    <li class="flex-shrink-0 inline-flex flex-col items-center justify-center min-w-[100px] text-black sm:flex-row sm:rounded-full sm:px-4 sm:py-2 sm:gap-3 lg:w-60 lg:h-24 nav-item get_menu1" id="pills-all" data-bs-toggle="pill" data-bs-target="#all" type="button">
        <img src="{{ asset('assets/website/images/1.webp') }}" alt="All" class="w-16 h-16 sm:w-20 sm:h-20 lg:w-20 lg:h-20 rounded-full object-cover shadow-md">
        <p class="text-base font-semibold mt-2 sm:mt-0">All</p>
      </li>
      @foreach ($category as $item)

    <li class="flex-shrink-0 inline-flex flex-col items-center justify-center min-w-[100px] text-black sm:flex-row sm:rounded-full sm:px-4 sm:py-2 sm:gap-3 lg:w-60 lg:h-24 get_menu" data-id="{{ $item->id }}" id="pills-all" data-bs-toggle="pill" data-bs-target="#all">
      <img src="{{ url($item->cate_img) }}" alt="Burger" class="w-16 h-16 sm:w-20 sm:h-20 lg:w-20 lg:h-20 rounded-full object-cover shadow-md">
        ...
        <div class="col-md-12 mb-3">
            ...
            <div class="main-scrollbar">
                    ...
                    <div class="col-8 col-sm-9">
                        <select class="form-control form-control-sm" id="apply_coupon">
                            ...
                            @foreach($coupons as $coupon)
                                <option value="{{ $coupon->coupon_name }}">{{ $coupon->coupon_name }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div id="redeem-points" class="d-flex justify-content-between align-items-center mb-2 mr-10">
                    <span>Redeem points: {{$UserPoints->points}}</span>
                    <button id="redeem" class="btn btn-orange btn-sm">Redeem</button>
                    <input type="hidden" value="{{$UserPoints->points}}" id="redeem_value">
                </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="main-scrollbar">
                                            <div class="card table-card mx-2">
                                                <div class="card-body">
                                                    <div class="table-responsive" style="background: hsl(0, 9%, 98%) !important;">
                                                        <table class="table table-striped table-order text-nowrap" style="width: 100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="product-item d-flex align-items-center">
                                                                                <img src="{{ url($product['image']) }}" class="rounded" style="height: 30px; width: 30px;">
                                                                                <div>
                                                                                    <b>{{ $product['name'] }}</b>
                                                                                    @if($product['variant'])
                            ...
                            <div class="card h-100 shadow-sm border-0" style="background-color: #ffffff;">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="{{ url($product['image']) }}" alt="Product Image" class="rounded" style="width: 60px; height: 60px; object-fit: cover; margin-right: 15px;">
                                        <div>
                                            <h5 class="mb-1" style="font-size: 1rem; font-weight: bold;">{{ $product['name'] }}</h5>
                                            @if($product['variant'])
                                                <div style="font-size: 0.875rem;">{!! $product['variant'] !!}</div>
                                            @endif
                                            @if($product['crust'])
                                                <div style="font-size: 0.875rem;">{!! $product['crust'] !!}</div>
                                            @endif
                                            @if($product['toppings'])
                                                <div style="font-size: 0.875rem;">{!! $product['toppings'] !!}</div>
                                            @endif
                                        </div>
                                    </div>
                                                ...
                                                <div class="contact-form">
                                                    <form method="POST" class="update_profile">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" style="font-size: 14px; font-family: var(--fontFamily-dm_sans); color:#2D1E16;">
            Date of Birth
        </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 formrow formbtn">
                                                        <button type="submit" name="submit"
                                                            class="btn w-100 btn-addres" style="background-color: #A07E55; color: white;">Submit</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <!--Edit User Address-->
                           <div class="modal fade" id="editAddModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog  modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel" style="color: #A07E55;">Update Address</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="contact-form" style="padding: 20px !important;">
                                            <form class="update_user_address" method="POST">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 formrow formbtn">
                                                        <button type="submit" name="submit"
                                                            class="btn  w-100" style="background-color: #A07E55; color: white;">Submit</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
<div id="" class="col-md-12 mt-8 px-6 cart_full   " style="display:none" >
                    ...
                    <div id="redeem-points" class="mt-3">
                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            <div class="font-medium"> Redeem points:  {{$UserPoints->points}} </div><div><span><button style="padding: 1px 8px;font-size: 10px;" class="btn btn-danger" id="redeem">Redeem</button></span></div>
                        </div>
...
`;
            ...
            $("body").on("click", "#place_order", function(e) {
             ...
             var tables = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "{{ route('website.order_history',[$branch_id,$table_id]) }}",
