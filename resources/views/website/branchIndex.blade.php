    ...
    <article>
        <section>
            <div class="img-cont zoom-animation">
                <img src=" {{ asset('assets/website/indexImages/banner_branch.png') }}" alt="Image">
                <div class="dark"></div>
                <div class="text-overlay banner-text" style="color: var(--white);
      font-family: var(--fontFamily-forum);
      font-size: var(--fontSize-display-1);
      line-height: var(--lineHeight-1);">
                    <div>{!! translate('discover_south_indian_cuisine') !!}</div>
                </div>
                ...
                <div class="mx-auto"
                    ...
                    <!-- <h2 class="section-title headline-2-0 text-start my-5 pr-0 md:pr-0 lg:pr-[12rem]"
                        style="padding-left:0rem;">
                         <img style="width: 450px; ;" src="{{ asset('assets/website/indexImages/seprator.png') }}" alt="">
                        Where tradition meets taste: <h2><span style="font-size:45px;"> Join
                        us for a memorable Andhra Dining experience. </span></h2>
                    </h2> -->

                    <div class="" style="">
                        <img class="tradition_seprator" src="{{ asset('assets/website/indexImages/seprator.png') }}"
                            alt="">
                        <h2 class=" headline-2-0 text-start" style="padding-left:0rem;">
                            {!! translate('where_tradition_meets_taste') !!}
                        </h2>
                        <h2 class=" headline-2-0 text-start " style="padding-left:0rem;">
                            {!! translate('join_us_for_a_memorable_andhra_dining_experience') !!}
                        </h2>
                    </div>
                    ...
                    <div class="features-imgs mx-auto my-5">
                        <div class="block md:flex lg:flex gap-10 items-center justify-center "
                            ...
                            <div class="grid gap-7 w-full h-64">
                                <img class="w-full" src="{{ asset('assets/website/indexImages/branches_gallery.jpg') }}"
                                    style="object-fit: cover;">
                                <img class="w-full" src="{{ asset('assets/website/indexImages/1.jpg') }}"
                                    style="object-fit: cover; height: 325px">
                            </div>
                            <div class="w-full h-64 mt-10 lg:mt-0 md:mt-0">
                                <img class="w-full h-full"
                                    src="{{ asset('assets/website/indexImages/branches_gallery2.webp') }}"
                                    style="object-fit: cover;">
                            </div>
                        </div>
                    </div>
