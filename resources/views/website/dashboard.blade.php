            ...
            <div>
                <section class="hero text-center" aria-label="home" id="home" style="height:100%;">
                    <ul class="hero-slider" data-hero-slider>
                        <li class="slider-item active" data-hero-slider-item>
                            <div class="slider-bg">
                                <img src="{{ asset('assets/website/indexImages/hero-slider-1.jpeg') }}" alt=""
                                    class="img-cover">
                            </div>
                            <h1 class="display-1 hero-title slider-reveal">
                                {!! translate('andhra_born_in_japan') !!}
                            </h1>
                        ...
                        <li class="slider-item" data-hero-slider-item>
                            <div class="slider-bg">
                                <img src="{{ asset('assets/website/indexImages/Home2.png') }}" alt="" class="img-cover">
                            </div>
                            <h1 class="display-1 hero-title slider-reveal">
                                {!! translate('where_andhra_comes_to_life') !!}
                            </h1>
                        </li>
                        <li class="slider-item" data-hero-slider-item>
                            <div class="slider-bg">
                                <img src="{{ asset('assets/website/indexImages/home3.png') }}" alt="" class="img-cover">
                            </div>
                            <h1 class="display-1 hero-title slider-reveal">
                                {!! translate('where_every_flavor_tells_a_story') !!}
                            </h1>
                        </li>
                    </ul>
                ...
                <div class="pt-20" style="background-color: #E7E5DC; ">
                    <div class=" lg:flex justify-center">
                        ...
                        <div class=" flex-1 lg:mr-20">
                            <img src="{{ url($ayurveda->philosophy_banner) }}" alt="Your Image"
                        ...
                        <div class="flex-1 p-8 flex flex-col justify-center lg:ml-[40px]" style="">
                            <div class="w-full">
                                ...
                                <img class="img_size" src="{{ asset('assets/website/indexImages/seprator.png') }}"
                                    alt="">
                                <!-- <p class="section-subtitle-3 label-2-0"></p> -->
                                <h2 class="headline-1 section-title" style="">{!! translate('Our_Philosophy') !!}</h2>
                            </div>
                            <p class="pw w-[100%] text-justify font-light"
                                style="font-family:var(--fontFamily-dm_sans);">
                                {{ app()->getLocale() == 'ja' ? $ayurveda->philosophy_description_jpn : $ayurveda->philosophy_description}}<br /><br />
                                <span style="text-align:start"
                                    style="font-family:var(--fontFamily-dm_sans); ">{!! translate('andhra_born_in_japan') !!}</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <section class="section event " aria-label="event" style=" background-color:#FFFFFF;">
                    <div class="container" style="padding-top:40px;">
                        <div class="" style="">
                            <img class="latest_seprator" src="{{ asset('assets/website/indexImages/seprator.png') }}"
                                alt="">
                            <!-- <p class="section-subtitle-3 label-2-0"></p> -->

                            <h2 class=" headline-2-0 text-[30px]  text-start pr-0 md:pr-0 lg:pr-[12rem]"
                                style="padding-left:0rem; ">{!! translate('latest_updates') !!}
                            </h2>
                            <h2 class=" headline-2-0 text-[25px] text-start pr-0 md:pr-0 lg:pr-[12rem]"
                                style="padding-left:0rem;">{!! translate('Discover what') !!}
                            </h2>
                        </div>
                                ...
                                <div class="flex flex-col text-justify items-center h-full gap-15"
                                    ...
                                    <div class="p-5"
                                        ...
                                        <p class="text-center text-lg leading-10"
                                            ...
                                            {!! app()->getLocale() == 'ja' ? $data->name_jpn : $data->name !!}
                                        </p>
                                        <p class=""
                                            style="text-justify color: #6A432A; font-family: 'DM Sans', sans-serif; line-height: 22px; margin-top: {{ $data->name === 'TELUGU MOVIES IN TOKYO' ? '0px;' : '0px;' }} font-size: 14px;">
                                            {!! app()->getLocale() == 'ja' ? $data->headline_jpn : $data->headline !!}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
                ...
                <section>
                    <div class="pt-20 "
                        style="position: relative; background-image: url('{{ asset('assets/website/indexImages/ricebanner.png') }}'); background-repeat: no-repeat; background-size: cover; height: 500px;">
                        <div
                        ...
                        <div class="ind">
                            <h1 class="headline-1 section-title" style="color:white">
                                {!! translate('indulge_in_exotic_delights') !!}
                            </h1>
                            <a href="{{ route('website.branchIndex') }}" class="btn btn-primary"
                                style="color: white; border-color: white; margin-top:25px;">
                                <span class="text text-1">{!! translate('Our_Restaurants') !!}</span>
                            </a>
                        </div>
                    </div>
                </section>
                ...
                <section class="section  event bg-black-10-1" aria-label="event">
                    <div class="container dp-container" style="display: flex; flex-direction: column;">
                        <div class="">
                            <div style="width:80%">
                                <!-- <img style="width: 250px;" class="sm:ml-52 xl:ml-80" src="{{ asset('assets/website/indexImages/seprator.png') }}" alt=""> -->
                            </div>
                            ...
                            <h2 class="section-title headline-2-0 text-start lg:my-5 lg:pl-19 lg:pr-19">
                                {!! translate('Discover_the_Rich_Cultural_Hub') !!}
                            </h2>
                            <div class="dp text-justify"
                                style="display: flex; flex-direction: column; align-items: center;">
                                <p>
                                    {!! app()->getLocale() == 'ja' ? $dataAndra->andra_jp : $dataAndra->andra !!}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section event  bg-black-10 pt-20 pb-11" aria-label="event" style="">
                    <div class="container">
                        ...
                        <!-- <img style="width: 250px" src="{{ asset('assets/website/indexImages/seprator.png') }}" alt=""> -->
                        <h2 class=" text-[#A07E55] headline-2-0 text-start lg:my-5  " style="padding-left:0rem;">
                            {!! translate('At_Andhra_Dining_we_always_Strive') !!}
                        </h2>
                        <div
                            ...
                            <div class="feature-card"
                                ...
                                <div class="card-icon mx-auto"><img
                                        src=" {{ asset('assets/website/indexImages/features-icon-2.png') }} "
                                ...
                                <p class="text-center text-lg leading-10 my-10 "
                                    ...
                                    {!! translate('premium_quality') !!}
                                </p>
                                <p class="text-center"
                                    style="color: #6A432A; font-family: 'DM Sans', sans-serif; line-height: 22px;font-size: 15px;">
                                    {!! translate('serve_our_customers_with_the_best') !!}
                                </p>
                            </div>
                            <div class="feature-card"
                                style="color: #6A432A; text-align: start; background-color: #E7E5DC; width: 100%; height: 100%;">
                                <div class="card-icon mx-auto"><img
                                        src=" {{ asset('assets/website/indexImages/features-icon-1.png') }} "
                                        width="100" height="100" loading="lazy" alt="icon"></div>
                                <p class="text-center text-lg leading-10 my-10"
                                    style="text-align: start; font-size: xx-large; letter-spacing: 3px; color: #6A432A;font-family:var(--fontFamily-forum);">
                                    {!! translate('fresh_ingredients') !!}
                                <p class="text-center"
                                    style="color: #6A432A; font-family: 'DM Sans', sans-serif; line-height: 22px;font-size: 15px;">
                                    {!! translate('We_prepare_delicious_South_Indian_food') !!}
                                </p>
                            </div>
                            <div class="feature-card"
                                style="color: #6A432A; text-align: start; background-color: #E7E5DC;width: 100%; height: 100%;">
                                <div class="card-icon mx-auto"><img
                                        src=" {{ asset('assets/website/indexImages/features-icon-3.png') }} "
                                        width="100" height="100" loading="lazy" alt="icon"></div>
                                <p class="text-center text-lg leading-10 my-10"
                                    style="text-align: start; font-size: xx-large; letter-spacing: 3px; color: #6A432A; font-family:var(--fontFamily-forum);">
                                    {!! translate('homemade_masala') !!}
                                </p>
                                <p class="text-center"
                                    style="color: #6A432A; font-family: 'DM Sans', sans-serif; line-height: 22px;font-size: 15px;">
                                    {!! translate('To_provide_the_most_authentic_taste') !!}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container h-full w-full flex gap-[10px] justify-center items-center bg-white"
                    ...
                    <div class="flex">
                        <div class="w-1/2" style="margin-right:15px;">
                            <img src="{{ asset('assets/website/indexImages/pasta.jpeg') }}" alt="Image 1"
                                class="w-full h-full object-cover">
                        </div>
                        <div class="w-1/2" style="margin-left:15px;">
                            <img src="{{ asset('assets/website/indexImages/home-leftimg.jpeg') }}" alt="Image 2"
                                class="w-full h-full object-cover">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="text-width" style=" display: flex;  ">
                            <h2 class="section-title headline-2-0 text-start my-5 pr-0 md:pr-0 lg:pr-[12rem]"
                                ...
                                <img class="Excellence_seprator" class=""
                                    src="{{ asset('assets/website/indexImages/seprator.png') }}" alt="">
                                {!! translate('celebrating_excellence_award_winning_achievements') !!}
                                <p>{!! translate('Our Award-Winning Achievements') !!}</p>
                            </h2>
                        </div>
                        <div class="container text-5xl flex justify-center pt-5" style="background-color:#FFFFFF">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-x-20 gap-y-12 p-30">
                                ...
                                <div class="text-center bg-white flex justify-end gap-y-6 flex-col "
                                    ...
                                    <div class="container">
                                        <img src="{{ asset('assets/website/indexImages/award1.png') }}"
                                ...
                                <div class="text-center bg-white flex flex-col my-auto  justify-end"
                                    ...
                                    <div class="container h-1/2 flex justify-end items-end my-auto">
                                        <img src="{{ asset('assets/website/indexImages/award3.png') }}"
                                ...
                                <div class="text-center bg-white flex flex-col justify-end "
                                    style="lg:width: 400px; height: 350px;">
                                    <div class="container">
                                        <img src="{{ asset('assets/website/indexImages/award2.png') }}"
                ...
                <d iv class="gtco-testimonials h-screen flex flex-col justify-center items-center "
                    ...
                    <h2 style="font-size:38px; color:#A07E55; font-family:var(--fontFamily-forum);"
                        class="text-center  font-normal text-gray-700 mb-10">{!! translate('customer_reviews') !!}</h2>
                    <div class="owl-carousel owl-carousel1 owl-theme">
                        @foreach ($review as $item)
                            <div>
                                <div class="card text-center"><img class="card-img-top"
                                        src="{{ asset('assets/website/indexImages/review1.svg') }}" alt="">
                                    <div class="card-body">
                                        <h5>{{ $item->name }}</h5>
                                    ...
                                    <div class="feedback-wrapper">
                                        ...
                                        <form action="{{ route('website.storeReview') }}" method="post" class="form">
                                            ...
                                            <textarea name="opinion" cols="30" rows="5"
                                                placeholder="{!! stripParagraphTags(translate('How was your experience dining at Andhra Dining?')) !!}"
                                                required></textarea>
                ...
                <section>
                    <div class=""
                        style=" position: relative; background-image: url('{{ asset('assets/website/indexImages/homebannerr.jpeg') }}'); background-repeat: no-repeat; background-size: cover; height: 400px;">
                        <div
                            style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5);">
                        </div>
                    </div>
