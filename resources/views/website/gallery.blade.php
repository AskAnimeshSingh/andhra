    ...
    <article>
      <section>
        <div class="img-cont zoom-animation">
          <img src=" {{ asset('assets/website/indexImages/0.jpg') }}" alt="Image">
          <div class="dark"></div>
            ...
            <div class="g-body">
              <div class="parent-container">
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/1.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/4.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/3.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/4.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/5.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/6.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/6.jpg') }}">
                </div>
                ...
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/9.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/13.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/11.jpg') }}">
                </div>
                <div class="image-container">
                  <img src="{{ asset('assets/website/indexImages/12.jpg') }}">
                </div>
              </div>
            </div>
