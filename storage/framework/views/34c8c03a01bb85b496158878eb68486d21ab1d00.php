...
<script>
  ...
  $("body").on("submit", ".store_user", function(e) {
    ...
    $.ajax({
      url: "<?php echo e(route('admin.staff.store')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  var tables = $('#staff').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      url: "<?php echo e(route('admin.staff.staff_ajax_list')); ?>",
  ...
  $("body").on("submit", ".edit_user", function(e) {
    ...
    fd.append('_token', "<?php echo e(csrf_token()); ?>");
    $.ajax({
      url: "<?php echo e(route('admin.staff.update')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  $("body").on("click", ".statusVerifiedClick", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.staff.status')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
  ...
  $("body").on("click", ".user-delete", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.staff.destroy')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/staff/index.blade.php ENDPATH**/ ?>