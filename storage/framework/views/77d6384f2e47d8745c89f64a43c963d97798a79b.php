        ...
        <div class="section body">
            ...
            <div class="col-12">
                <div class="row" style="justify-content: start; gap: 15px; display: flex;">
                    <?php if(count($cooking) > 0): ?>
                        <?php $__currentLoopData = $cooking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
...
<?php echo $__env->make('kitchen.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/kitchen/order/order_cooking_list.blade.php ENDPATH**/ ?>