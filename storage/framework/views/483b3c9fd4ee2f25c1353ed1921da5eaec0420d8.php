                            ...
                            <div class="col-md-12">
                                <div class="sidebar left ">
                                    ...
                                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li> <a href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard<?php echo e($item->id); ?>" data-id="<?php echo e($item->id); ?>" class="collapsed active get_menu" > <img src="<?php echo e(url($item->cate_img)); ?>" style="height:23px; width:23px" alt=""> <span class="nav-label"> <?php echo e($item->cate_name); ?> </span> <span class="fa fa-chevron-left pull-right"></span> </a>
                                            <ul class="sub-menu collapse sub_category_list" id="dashboard<?php echo e($item->id); ?>">
                                            </ul>
                                        </li>
                    ...
                    <div class="modal-body">
                        <div class="container px-0 mt-3">
                            <div class="ticket section-to-print">
                                <img src="<?php echo e(url('public/assets/website/indexImages/changed_logo.png')); ?>" alt="Logo">
                                <p class="centered">KOT Receipt
                                    <br>Date: <?php echo e(date('D m, Y')); ?>
...
<?php $__env->startSection('extra_js'); ?>
    ...
    <script>
        ...
        $(function() {
            ...
            $('.print-kot').click(function(e){
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('admin.get_cart_list_ajax')); ?>",
                    data: {
                        branch_id: branch_id,
                        table_id: table_id,
                    },
    ...
    <script>
        ...
        $(function() {
            ...
            $.fn.product = function(limit, newest, asc, cate_id, sub_cate_id) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('admin.get_menu')); ?>",
                    beforeSend: function() {
                        $('.loaded').show();
                    },
                    success: function(data) {
            ...
            $.fn.subCateory = function(cate_id) {
                $.ajax({
                    ...
                    url: "<?php echo e(route('admin.get_sub_category')); ?>",
                    beforeSend: function() {
                        $('.loaded').show();
                    },
                    success: function(data) {
            ...
            $("body").on("click", ".add_to_cart", function(e) {
                ...
                fd.append('table_id', '<?php echo e($table_id); ?>');
                fd.append('id', id);
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.add_to_cart')); ?>",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
            ...
            $("body").on("click", ".remove_to_cart", function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.remove_from_cart')); ?>",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
            ...
            $("body").on("click", ".increment", function(e) {
                ...
                fd.append('id', id);
                $.ajax({
                    url: "<?php echo e(route('admin.qty_increase')); ?>",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
            ...
            $("body").on("click", ".decrement", function(e) {
                ...
                fd.append('id', id);
                $.ajax({
                    url: "<?php echo e(route('admin.qty_decrease')); ?>",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
            ...
            $("body").on("click", "#place_order", function(e) {
                ...
                if (type != "") {
                    $.ajax({
                        url: "<?php echo e(route('admin.place_order')); ?>",
                        type: "POST",
                        data: fd,
                        dataType: 'json',
                        processData: false,
        ...
        $("body").on("click", "#coupon_apply", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.check_coupon')); ?>",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
        ...
        $.fn.combo = function(newlimit) {
            $.ajax({
                ...
                url: "<?php echo e(route('admin.get_combo_pack')); ?>",
                beforeSend: function() {
                    $('.loaded').show();
                },
                success: function(data) {
        ...
        $("body").on("click", ".combo_add_to_cart", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.combo_pack_add_to_cart')); ?>",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
            ...
            iziToast.show({
                ...
                buttons: [
                    ['<button>Yes</button>', function(instance, toast) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('admin.payNow')); ?>', 
                            method: 'POST', 
            ...
            iziToast.show({
                ...
                buttons: [
                    ['<button>Yes</button>', function(instance, toast) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('admin.cancel')); ?>', 
                            method: 'POST', 
                            processData: false,  // Prevent jQuery from processing data
                            contentType: false,  // Prevent jQuery from setting contentType
                            data: fd,
...
<script>
$(document).ready(function() {
    var branch_id = <?php echo e($branch_id ?? 'null'); ?>;
    var table_id = <?php echo e($table_id ?? 'null'); ?>;
...
<?php echo $__env->make('admin.layout.poslayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/pos/index.blade.php ENDPATH**/ ?>