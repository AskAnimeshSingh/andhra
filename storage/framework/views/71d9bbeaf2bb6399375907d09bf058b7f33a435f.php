...
<script>
  ...
  var tables = $('#category').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      url: "<?php echo e(route('admin.properties.properties_ajax_list')); ?>",
  ...
  $("body").on("submit", ".edit_properties", function(e) {
    ...
    fd.append('_token', "<?php echo e(csrf_token()); ?>");
    $.ajax({
      url: "<?php echo e(route('admin.properties.update')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  $("body").on("click", ".statusVerifiedClick", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.properties.status')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
  ...
  $("body").on("click", ".properties-delete", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.properties.destroy')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/properties/index.blade.php ENDPATH**/ ?>