    ...
    <article>
      ...
      <section>
        <div class="img-cont zoom-animation">
          <img src=" <?php echo e(asset('assets/website/indexImages/home3.png')); ?>" alt="Image">
          <div class="dark"></div>
          <div class="text-overlay banner-text" style="color: var(--white);
    font-family: var(--fontFamily-forum);
    font-size: var(--fontSize-display-1);
    line-height: var(--lineHeight-1);">
            <div><?php echo translate('from_our_kitchen_to_your_heart'); ?></div>
          </div>
        </div>
      </section>
      ...
      <section class="section event bg-black-10-1" aria-label="event">
        <div class="container dp-container" style="display: flex; flex-direction: column;">
          <div class="lg:ml-[192px]" style="">
            <img class="flavours_seprator" src="<?php echo e(asset('assets/website/indexImages/seprator.png')); ?>" alt="">
            <!-- <p class="section-subtitle-3 label-2-0"></p> -->
            <h2 class=" headline-2-0 text-start" style="padding-left:0rem;"><?php echo translate('flavours_of_home'); ?> </h2>
            <h2 class=" headline-2-0 text-start text-[28px]" style="padding-left:0rem;">
              <?php echo translate('discover_our_story'); ?>

            </h2>
          </div>
          <!-- <img style="width: 425px; margin-left:192px " class=" sm:ml-56" src="<?php echo e(asset('assets/website/indexImages/seprator.png')); ?>" alt="">
      ...
      <section style="padding:20px 0px; background-color:#FFFFFF;">
        <div class="grid grid-cols-2 gap-10 w-full" style="object-fit: contain;">
          <img src="<?php echo e(asset('assets/website/indexImages/about_curry.png')); ?>" alt="Image 1" class="w-full h-full">
          <img src="<?php echo e(asset('assets/website/indexImages/about_left.png')); ?>" alt="Image 2" class="w-full h-full">
        </div>
      </section>
      ...
      <section class="section about text-center md:pt-[100px]" aria-labelledby="about-label" id="about"
        ...
        <div class="abt container mx-auto w-full max-w-full" style="gap:80px;">
          ...
          <!-- <img style="width: 375px ; "   src="<?php echo e(asset('assets/website/indexImages/seprator.png')); ?>" alt="">
          ...
          <div class="about-content p-10 lg:p-0 md:p-0" style="margin:auto;">
            <div class="" style="">
              ...
              <h2 class=" headline-2-0 text-start" style="padding-left:0rem;">
                <?php echo app()->getLocale() == 'ja' ? $data->head_chef_name_jpn : $data->head_chef_name; ?>:<br>
                <?php echo translate('head_chef_from_andhra'); ?>

              </h2>
              <!-- <h2 class=" headline-2-0 text-start "
              style="padding-left:0rem; font-size:45px;" ><?php echo translate('our_head_chef_from_andhra'); ?></h2> -->
            </div>
            <p class="section-txt my-auto text-justify pt-4"
              style="font-family:var(--fontFamily-dm_sans); padding-right:5px;">
              <?php echo e(app()->getLocale() == 'ja' ? $data->head_chef_description_jpn : $data->head_chef_description); ?>
      ...
      <section class="section about lg:pb-20 pb-10" aria-labelledby="about-label" id="about"
        ...
        <div class="abt2 container mx-auto" style="margin:0px; gap:80px; max-width:2560px;">
          <figure class="chef-img lg:h-full lg:object-fill xl:h-full xl:object-fill">
            <img src="<?php echo e(asset('assets/website/indexImages/chef3.png')); ?>" width="600" height="600" loading="lazy"
          ...
          <div class="about-content-1 p-10 lg:p-0 md:p-0" style="margin:auto;">
            <div class="" style="">
              <img class="Behind_seprator" src="<?php echo e(asset('assets/website/indexImages/seprator.png')); ?>" alt="">
              <!-- <p class="section-subtitle-3 label-2-0"></p> -->
              <h2 class=" headline-2-0 text-start" style="padding-left:0rem;"><?php echo translate('Behind_the_Scenes'); ?>

              </h2>
              <h2 class=" headline-2-0 text-start " style="padding-left:0rem; ">
                <?php echo translate('get_to_know_our_talented_chefs'); ?>

              </h2>
            </div>
            <!-- <p class="section-subtitle-5 label-2-0 text-start mr-[55px]" style="margin-bottom:15px;"></p> -->
            <!-- <img style="width: 460px; margin-bottom:36px;" src="<?php echo e(asset('assets/website/indexImages/seprator.png')); ?>" alt="">
            ...
            <p class="section-txt text-justify pt-4" style="font-family:var(--fontFamily-dm_sans); ">
              <?php echo e(app()->getLocale() == 'ja' ? $data->chef_description_jpn : $data->chef_description); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/website/aboutus.blade.php ENDPATH**/ ?>