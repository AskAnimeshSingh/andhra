...
<?php $__env->startSection('extra_js'); ?>
    ...
    <script>
        ...
        var tables = $('#category').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo e(route('admin.ratings_ajax_list')); ?>",
        ...
        $("body").on("click", ".statusVerifiedClick", function (e) {
            ...
            $.confirm({
                ...
                buttons: {
                    yes: function () {
                        $.ajax({
                            url: "<?php echo e(route('admin.ratings.status')); ?>",
                            type: 'POST',
                            data: fd,
                            dataType: "JSON",
                            contentType: false,
        ...
        $("body").on("click", ".category-delete", function (e) {
            ...
            $.confirm({
                ...
                buttons: {
                    yes: function () {
                        $.ajax({
                            url: "<?php echo e(route('admin.ratings.destroy')); ?>",
                            type: 'POST',
                            data: fd,
                            dataType: "JSON",
                            contentType: false,
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/rating/index.blade.php ENDPATH**/ ?>