...
<section class="section">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModal">Add New Waiter</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form class="store_waiter" method="POST">
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" a  ria-labelledby="formModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModal">Edit Waiter</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<script>
  ...
  // Category Store
  $("body").on("submit", ".store_waiter", function(e) {
    e.preventDefault()
    let fd = new FormData(this)
    fd.append('_token', "<?php echo e(csrf_token()); ?>");
    $.ajax({
      url: "<?php echo e(route('admin.waiter.store')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  var tables = $('#staff').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      url: "<?php echo e(route('admin.waiter.waiter_ajax_list')); ?>",
  ...
  $("body").on("submit", ".edit_user", function(e) {
    ...
    fd.append('_token', "<?php echo e(csrf_token()); ?>");
    $.ajax({
      url: "<?php echo e(route('admin.waiter.update')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  $("body").on("click", ".statusVerifiedClick", function(e) {
    ...
    $.confirm({
      title: 'Confirm!',
      content: 'Sure you want to change waiter status?',
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.waiter.status')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
  ...
  $("body").on("click", ".user-delete", function(e) {
    ...
    $.confirm({
      title: 'Confirm!',
      content: 'Sure you want to delete this waiter type ?',
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.waiter.destroy')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/waiter/index.blade.php ENDPATH**/ ?>