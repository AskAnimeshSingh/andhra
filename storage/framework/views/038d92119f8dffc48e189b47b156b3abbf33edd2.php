...
<style>
    ...
    .banner {
        ...
        background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
            url(" <?php echo e(asset('assets/website/indexImages/banner-img.jpg')); ?> ") center/cover no-repeat;
        display: flex;
        flex-direction: column;
        justify-content: center;
        align-items: center;
    ...
    .card-img {
        background: url(" <?php echo e(asset('assets/website/indexImages/4.jpg')); ?> ") center/cover no-repeat;
        width: 100%;
        height: 100%;
    }
    ...
    .hero-section {
        ...
        align-items: center;
        justify-content: center;
        background-image: url("<?php echo e(asset('assets/website/indexImages/unique-bg.jpg')); ?>");
...
<body id="top">
                ...
                <section class="hero text-center " aria-label="home" id="home" class="banner-section">
                    ...
                    <ul class="hero-slider" data-hero-slider>
                        <li class="slider-item active" data-hero-slider-item>
                            <div class="slider-bg">
                                <img src=" <?php echo e(asset('assets/website/indexImages/ginza.jpeg')); ?> " width="1880"
                                    height="950" alt="" class="img-cover">
                            </div>
                            <div class="">
                                <h1 class="headline-1" style="color:#fff;">
                                    <?php echo app()->getLocale() == 'ja' ? $branchData->type_jpn : $branchData->type; ?>

                                </h1>
                                <h1 class="hero-title slider-reveal">
                                    <?php echo app()->getLocale() == 'ja' ? strtoupper($branchData->name_jpn) : strtoupper($branchData->name); ?>
    ...
    <section class="section event bg-black-10-1" aria-label="event">
        <div class="container dp-container" style="display: flex; flex-direction: column;">
            <div class="lg:ml-[192px]" style="">
                <img class="discover_seprator" src="<?php echo e(asset('assets/website/indexImages/seprator.png')); ?>" alt="">
                <!-- <p class="section-subtitle-3 label-2-0"></p> -->
                <h2 class=" headline-2-0 text-start font-size-[28px]" style="padding-left:0rem;">
                    <?php echo translate('discover_our_story'); ?>

                </h2>
                <h2 class=" headline-2-0 text-start " style="padding-left:0rem;"><?php echo translate('The making of'); ?>
            ...
            <div class="dp pt-4"
                ...
                <?php echo translate('Discover the mouthwatering delight of'); ?>
    ...
    <div style="padding: 100px 0 100px 0; background-color:#FFFFFF;">
        ...
        <div class="min">
            <div class="tan-img"><img src=" <?php echo e(url($branchData->specialty_1)); ?> " alt="..." height="" width="" /></div>
            <div class="tan-text">
                <h2 class="headline-1 section-title" style="margin-bottom: 25px;">
                    <?php echo app()->getLocale() == 'ja' ? $branchData->specialty_1_title_jpn : $branchData->specialty_1_title; ?>
                ...
                <p class="tan-p w-full lg:w-1/2"
                    ...
                    <?php echo app()->getLocale() == 'ja' ? $branchData->specialty_1_description_jpn : $branchData->specialty_1_desccription; ?>
        ...
        <div class="min2">
            <div class="tan-text2">
                <h2 class="headline-1 section-title mx-auto" style="margin-bottom: 25px;">
                    <?php echo app()->getLocale() == 'ja' ? $branchData->specialty_2_title_jpn : $branchData->specialty_2_title; ?>

                </h2>
                <p class="tan-p w-full lg:w-1/2 mx-auto"
                    style="font-size:15px; display: flex; flex-direction: column; align-items: center; text-align:justify; font-family: var(--fontFamily-dm_sans);">
                    <?php echo app()->getLocale() == 'ja' ? $branchData->specialty_2_description_jpn : $branchData->specialty_2_description; ?>

                </p>
            </div>
            <div class="tan-img2">
                <img src=" <?php echo e(url($branchData->specialty_2)); ?> " alt="..." height="" width="" />
            </div>
        </div>
    </div>
    ...
    <section>
        <div class=""
            style="position: relative; background-image: url('<?php echo e(asset('assets/website/indexImages/bannerindex2.png')); ?>'); background-repeat: no-repeat; background-size: cover; height: 500px;">
            <div
                style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5);">
            </div>
            <div class="ind">
                <h1 class="headline-1 section-title" style="color:white"><?php echo translate('discover_whats_new'); ?></h1>
                <a href="<?php echo e(route('website.menuPage', ['id' => $id])); ?>" class="btn btn-primary unique-btn"
                    style="margin: 15px 0 0 0;">
                    <span class="text text-1"><?php echo translate('our_menu'); ?> </span>
                    <span class="text text-2" aria-hidden="true"><?php echo translate('our_menu'); ?></span>
                </a>
            </div>
        </div>
    </section>
...
foreach ($imageUrls as $imageUrl) {
                            ?>
                                                            <div class="image-box">
                                                                <img class="gImg" src="<?php echo e(asset('assets/website/indexImages/' . $imageUrl)); ?>" alt="" />
                                                                <div class="logo_icons">
                                                                    <a href="#">
                                                                        <div class="text_content">
                                                                            <span class="name"><?php echo e($branchData->name); ?></span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                            </div>
    ...
    <section class="section about text-center" aria-labelledby="about-label" id="about"
        ...
        <div class="abt container mx-auto w-full max-w-full" style="gap:80px;">
            ...
            <div class="about-content p-10 lg:p-0 md:p-0" style="margin:auto;">
                <div class="" style="">
                    <img class="chef_seprator" src="<?php echo e(asset('assets/website/indexImages/seprator.png')); ?>" alt="">
                    <!-- <p class="section-subtitle-3 label-2-0"></p> -->
                    <h2 class=" headline-2-0 text-start" style="padding-left:0rem;">
                        <?php echo translate('our_speciality_chef'); ?>
                ...
                <p class="section-txt my-auto pt-4"
                    ...
                    <?php echo stripParagraphTags(translate('our_hyderabad_dum_biryani')); ?>
            ...
            <figure class="about-banner lg:h-full lg:object-fill xl:h-full xl:object-fill"
                ...
                <img src="<?php echo e(asset('assets/website/indexImages/chef2.png')); ?>" loading="lazy" alt="about banner"
            ...
            <section class="location flex justify-between lg:items-start items-center">
                <div class="w-full h-full lg:pr-8">
                    <div class="map-container" id="gmap_canvas">
                        ...
                        <iframe src="<?php echo e($branchData->google_map_link); ?>" height="100%" width="100%" style="border:0;"
                ...
                <div class=" text-container text-center"
                    ...
                    <div class="address">
                        <a href="#" class="location-link">
                            <p style="width:100%">
                                <?php echo app()->getLocale() == 'ja' ? $branchData->address_jpn : $branchData->address; ?>

                                (<?php echo e($branchData->seating_ability); ?>
                        ...
                        <a href="#" class="location-link">
                            <p style="width:100%">
                                <?php echo app()->getLocale() == 'ja' ? $branchData->distance_from_jpn : $branchData->distence_from; ?>
        ...
        <div class="bg-white contact grid grid-cols-1 place-items-start justify-center text-center lg:text-start md:w-[40%] lg:w-[40%] xl:w-[40%] w-full h-full"
            ...
            <a href="#" class="contact-link" style="text-align:left">
                <p class="contact-link font-thin text-5xl" style="letter-spacing: 3px;">
                    <?php echo translate('business_hours'); ?>

                </p>
            </a>
            <a href="#" class="contact-link" style="text-align:left">
                <p class="font-thin lg:text-3xl" style="width:100%;"><?php echo stripParagraphTags(translate('Weekdays')); ?> -
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekday_opening)->format('g:iA')); ?> -
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekday_noon_close)->format('g:iA')); ?>,
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekday_noon_open)->format('g:iA')); ?> -
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekday_closing)->format('g:iA')); ?>
                ...
                <p class="font-thin lg:text-3xl pt-6" style="width:100%">
                    ...
                    -
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekend_opening)->format('g:iA')); ?> -
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekend_noon_close)->format('g:iA')); ?>,
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekend_noon_open)->format('g:iA')); ?> -
                    <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $branchData->weekend_closing)->format('g:iA')); ?>
        ...
        <div class="bg-white contact grid grid-cols-1 place-items-start justify-center text-center lg:text-start md:w-[40%] lg:w-[40%] xl:w-[40%] w-full h-full"
            ...
            <a href="#" class="contact-link" style="text-align:left">
                <p class="contact-link font-thin lg:text-5xl" style="letter-spacing: 3px;">
                    <?php echo stripParagraphTags(translate('contact_us')); ?>

                </p>
            </a>
            <a href="#" class="contact-link" style="text-align:left">
                <p class="font-thin lg:text-3xl" style="width:100%"><?php echo stripParagraphTags(translate('TEL')); ?> :
                    <?php echo e($branchData->phone); ?>

                </p>
                <p class="font-thin lg:text-3xl pt-6" style="width:100%"><?php echo stripParagraphTags(translate('Email')); ?>:
    ...
    <div class="container mx-auto w-full max-w-full" style="padding: 50px 0; background-color:white;">
        <div class="grid grid-cols-3 gap-8">
            <div class="overflow-hidden">
                <img src=" <?php echo e(asset('assets/website/indexImages/chicken.jpg')); ?> " alt=" Image 1"
                    class="w-full h-full object-cover">
            </div>
            <div class="overflow-hidden">
                <img src=" <?php echo e(asset('assets/website/indexImages/table.jpg')); ?> " alt="Image 2"
                    class="w-full h-full object-cover">
            </div>
            <div class="overflow-hidden">
                <img src=" <?php echo e(asset('assets/website/indexImages/dosa.jpg')); ?> " alt="Image 3"
                    class="w-full h-full object-cover">
            </div>
        </div>
    </div>
    ...
    <section>
        <div class=""
            ...
            <div class="ind">
                <h1 class="headline-1 section-title" style="color:white"><?php echo translate('we_value_your_opinion'); ?></h1>
                                ...
                                <div class="feedback-wrapper">
                                    ...
                                    <form action="<?php echo e(route('website.storeReview')); ?>" method="post" class="form">
                                        ...
                                        <textarea name="opinion" cols="30" rows="5"
                                            placeholder="<?php echo stripParagraphTags(translate('how_was_your_experience')); ?>"
                                            required></textarea>
    ...
    <div id="dynamicSectionsContainer" class="dynamic-sections-container pb-10 " style="margin-top: 50px;">
        <section class="banner">
            <h1 style="font-size: var(--fontSize-headline-2);margin: 10px;">
                <?php echo stripParagraphTags(translate('book_your_table_now')); ?>
                                ...
                                <form action="<?php echo e(route('website.reservation')); ?>" method="POST">
                                    ...
                                    <div class="form-row">
                                        <input type="text" name="firstName"
                                            placeholder="<?php echo stripParagraphTags(translate('first_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <input type="text" name="lastName"
                                            placeholder="<?php echo stripParagraphTags(translate('last_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-row">
                                        <input type="number" name="people"
                                            placeholder="<?php echo stripParagraphTags(translate('how_many_people')); ?>"
                                            min='1'>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-row">
                                        <input type="text" id="datepicker" name="days"
                                            placeholder="<?php echo stripParagraphTags(translate('select_date')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-row">
                                        <input type="tel" name="phone"
                                            placeholder="<?php echo stripParagraphTags(translate('phone_number')); ?>"
                                            min="1">
...
unset($__errorArgs, $__bag); ?>
                                        <input type="email" name="email"
                                            placeholder="<?php echo stripParagraphTags(translate('Email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-row" style="background-color:white;">
                                        <textarea
                                            placeholder="<?php echo stripParagraphTags(translate('do_you_have_any_dietary_requirements')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-row" style="background-color: #E7E5DC;">
                                        <button type="submit" class="btn"><?php echo translate('book_table'); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/website/branch.blade.php ENDPATH**/ ?>