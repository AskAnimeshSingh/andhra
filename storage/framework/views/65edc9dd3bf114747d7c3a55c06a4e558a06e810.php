...
<?php $__env->startSection('extra_js'); ?>
    <script>
        ...
        $("body").on("submit", ".store_ind_group", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.ind_grp.store')); ?>",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
        ...
        var tables = $('#group').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo e(route('admin.ind_grp.ind_grp_ajax_list')); ?>",
        ...
        $("body").on("submit", ".edit_ind_group", function (e) {
            ...
            fd.append('_token', "<?php echo e(csrf_token()); ?>");
            $.ajax({
                url: "<?php echo e(route('admin.ind_grp.update')); ?>",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
        ...
        $("body").on("click", ".statusVerifiedClick", function (e) {
            ...
            $.confirm({
                ...
                buttons: {
                    yes: function () {
                        $.ajax({
                            url: "<?php echo e(route('admin.ind_grp.status')); ?>",
                            type: 'POST',
                            data: fd,
                            dataType: "JSON",
                            contentType: false,
        ...
        $("body").on("click", ".ind-grp-delete", function (e) {
            ...
            $.confirm({
                ...
                buttons: {
                    yes: function () {
                        $.ajax({
                            url: "<?php echo e(route('admin.ind_grp.destroy')); ?>",
                            type: 'POST',
                            data: fd,
                            dataType: "JSON",
                            contentType: false,
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/ingredient_group/index.blade.php ENDPATH**/ ?>