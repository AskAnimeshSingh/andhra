...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped text-center" id="sub_category">
                                    <thead>
                                    <tr>
                    ...
                    <form class="store_cate" method="POST">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select type="text" class="form-control" placeholder="Category" name="category">
                        ...
                        <div class="input-group">
                            ...
                            <img class="img-thumbnail image-width mt-4 mb-3" id="previewImage"
                                 src="<?php echo e(asset('assets/admin/assets/img/default_cate.jpeg')); ?>" alt="your image"/>
                        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="formModal"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Edit Sub Category</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="edit_cate" method="POST">
                        ...
                        <div class="form-group">
                            <label>Sub Category Name:</label>
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Category" name="sub_category"
                                       id="edit_cate">
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <?php $__env->startSection('extra_js'); ?>
            <script>
                ...
                $("body").on("submit", ".store_cate", function (e) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('admin.sub_category.store')); ?>",
                        type: "POST",
                        data: fd,
                        dataType: 'json',
                        processData: false,
                        ...
                        success: function (result) {
                            if (result.status) {
                                ...
                                $('#sub_category').DataTable().ajax.reload(null, false);
                ...
                var tables = $('#sub_category').DataTable({
                    "processing": true,
                    pageLength: 10,
                    "serverSide": true,
                    "ajax": {
                        url: "<?php echo e(route('admin.sub_category_ajax_list')); ?>",
                ...
                $("body").on("submit", ".edit_cate", function (e) {
                    ...
                    fd.append('_token', "<?php echo e(csrf_token()); ?>");
                    $.ajax({
                        url: "<?php echo e(route('admin.sub_category.update')); ?>",
                        type: "POST",
                        data: fd,
                        dataType: 'json',
                        processData: false,
                ...
                $("body").on("click", ".statusVerifiedClick", function (e) {
                    ...
                    $.confirm({
                        title: 'Confirm!',
                        content: 'Sure you want to change sub category status?',
                        buttons: {
                            yes: function () {
                                $.ajax({
                                    url: "<?php echo e(route('admin.sub_category.status')); ?>",
                                    type: 'POST',
                                    data: fd,
                                    dataType: "JSON",
                                    contentType: false,
                ...
                $("body").on("click", ".category-delete", function (e) {
                    ...
                    $.confirm({
                        title: 'Confirm!',
                        content: 'Sure you want to delete this sub category ?',
                        buttons: {
                            yes: function () {
                                $.ajax({
                                    url: "<?php echo e(route('admin.sub_category.destroy')); ?>",
                                    type: 'POST',
                                    data: fd,
                                    dataType: "JSON",
                                    contentType: false,
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/sub_category/index.blade.php ENDPATH**/ ?>