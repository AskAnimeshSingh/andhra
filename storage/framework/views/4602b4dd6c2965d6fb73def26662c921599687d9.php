                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="store_properties" method="POST">
                            <input type="hidden" class="form-control" value="<?php echo e($id); ?>" placeholder="Properties Id"
                                   name="id" required>
...
<?php $__env->startSection('extra_js'); ?>
    <script>
        ...
        $("body").on("submit", ".store_properties", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.properties.items.store')); ?>",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
        ...
        var tables = $('#category').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo e(url('admin/properties/properties_item_ajax_list/'.$id)); ?>",
        ...
        $("body").on("submit", ".edit_properties", function (e) {
            ...
            fd.append('_token', "<?php echo e(csrf_token()); ?>");
            $.ajax({
                url: "<?php echo e(route('admin.properties.item.update')); ?>",
                type: "POST",
                data: fd,
                dataType: 'json',
                processData: false,
        ...
        $("body").on("click", ".statusVerifiedClick", function (e) {
            ...
            $.confirm({
                ...
                buttons: {
                    yes: function () {
                        $.ajax({
                            url: "<?php echo e(route('admin.properties.item.status')); ?>",
                            type: 'POST',
                            data: fd,
                            dataType: "JSON",
                            contentType: false,
        ...
        $("body").on("click", ".properties-delete", function (e) {
            ...
            $.confirm({
                ...
                buttons: {
                    yes: function () {
                        $.ajax({
                            url: "<?php echo e(route('admin.properties.item.destroy')); ?>",
                            type: 'POST',
                            data: fd,
                            dataType: "JSON",
                            contentType: false,
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/properties-items/index.blade.php ENDPATH**/ ?>