...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="branch_id" class="form-control"  id="branch_id" value="<?php echo e($id); ?>">
                                    <?php $__errorArgs = ['url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<script>
        ...
        //         $.ajax({
        //             url: "<?php echo e(route('admin.qr.create.info')); ?>",
        //             type: "POST",
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/qr/add.blade.php ENDPATH**/ ?>