    ...
    <style>
        * {
        ...
        body {
            ...
            background: url("<?php echo e(asset('assets/website/indexImages/andhrabg.jpg')); ?>") center center / cover no-repeat fixed;
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    <div class="container">
        <div class="logo-container">
            <img src="<?php echo e(asset('assets/website/indexImages/changed_logo.png')); ?>" alt="GoLala Logo" class="logo">
        </div>
        ...
        <?php if(session('error')): ?>
            <div class="session-error">
                <span>⚠️</span> <span id="session-error-text"><?php echo e(session('error')); ?></span>
            </div>
        <?php endif; ?>
        ...
        <form class="form_login" method="POST" novalidate>
            ...
            <input type="hidden" name="table_id" value="<?php echo e($table_id); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="error-message" id="phone-error">
                        <span>⚠️</span> <span id="phone-error-text"><?php echo e($message); ?></span>
                    </div>
                <?php unset($message);
...
</html><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/website/login.blade.php ENDPATH**/ ?>