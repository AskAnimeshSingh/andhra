                        ...
                        <form action="<?php echo e(route('admin.contact.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="Enter Phone Number" value="<?php echo e(isset($data->phone_number) ? $data->phone_number : ''); ?>" >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="email" placeholder="Enter Email Address" value="<?php echo e(isset($data->email) ? $data->email : ''); ?>" >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="facebook_link"  value="<?php echo e(isset($data->facebook_link) ? $data->facebook_link : ''); ?>" >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="insagram_link"  value="<?php echo e(isset($data->instagram_link) ? $data->instagram_link : ''); ?>" >
                                    <?php $__errorArgs = ['insagram_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="tiktok"  value="<?php echo e(isset($data->tiktok) ? $data->tiktok : ''); ?>" >
                                    <?php $__errorArgs = ['insagram_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if(isset($data->contact_banner)): ?>
                                    <img src="<?php echo e(url($data->contact_banner )); ?>" height="100" width="100"> 
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/contact/add.blade.php ENDPATH**/ ?>