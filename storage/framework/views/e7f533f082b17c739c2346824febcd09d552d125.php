        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.price.updatePrice',['id' => $id])); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="infoInput">Food List:</label>
                                    <select name="food" class="form-control"  id="">
                                        <?php if(isset($food)): ?>
                                        ...
                                        <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $getData->product_id ? 'selected' : ''); ?>><?php echo e($item->product_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <label for="infoTextArea">Price:</label>
                                    <input type="number" name="price" class="form-control" placeholder="Enter Price" id="" value="<?php echo e($getData->price); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <label for="recmd">Recommemded:</label>
                                    <input type="checkbox" name="recmd" <?php if($getData->recommend == 1): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/set_price/edit.blade.php ENDPATH**/ ?>