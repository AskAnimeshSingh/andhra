...
<script>
  ...
  var tables = $('#coupon').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      url: "<?php echo e(route('admin.coupon.coupon_ajax_list')); ?>",
...
$.fn.tableload();
  ...
  $("body").on("submit", ".edit_coupon", function(e) {
    ...
    fd.append('_token', "<?php echo e(csrf_token()); ?>");
    $.ajax({
      url: "<?php echo e(route('admin.coupons.update')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  $("body").on("click", ".coupon-delete", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.coupons.destroy')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u700657081/domains/xcrinogroup.com/public_html/andhra/resources/views/admin/coupons/index.blade.php ENDPATH**/ ?>