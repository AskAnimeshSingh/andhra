        ...
        <div class="modal-body">
          <form class="edit_variation" method="POST">
            <div class="form-group">
              <label>Variation Name:</label>
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Variation Name" name="name" id="edit_cate">
              </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/restaurant_pos/resources/views/admin/variation/index.blade.php ENDPATH**/ ?>