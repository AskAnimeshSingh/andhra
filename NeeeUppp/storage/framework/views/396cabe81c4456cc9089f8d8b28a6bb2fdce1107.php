        ...
        <div class="modal-body">
          <form class="edit_cate" method="POST">
            ...
            <div class="form-group">
              <label>Sub Category Name:</label>
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Category" name="sub_category" id="edit_cate">
              </div>
            </div>
            <div class="form-group">
              <label>Icon</label>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/restaurant-pos-backend/resources/views/admin/sub_category/index.blade.php ENDPATH**/ ?>