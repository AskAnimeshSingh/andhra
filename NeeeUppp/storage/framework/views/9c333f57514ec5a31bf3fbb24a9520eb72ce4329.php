...
//   }
  ...
  $("body").on("submit", ".add_gen", function(e) {
    ...
    $.ajax({
      url: "<?php echo e(route('admin.setting.store')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
      ...
      success: function(result) {
        if (result.status) {
          ...
          setTimeout(() => {
            window.location.href = "<?php echo e(url('admin/general-settings')); ?>"
          }, 500);
...
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/restaurant_pos/resources/views/admin/settings/generalsetting.blade.php ENDPATH**/ ?>