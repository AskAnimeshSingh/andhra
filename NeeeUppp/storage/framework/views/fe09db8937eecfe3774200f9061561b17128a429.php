            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ms-auto ">
                     ...
                     <li class="nav-item me-5">
                        <a class="nav-link p-0 text-white <?php echo e(request()->is('/privacy') == "privacy" ? 'active' : ''); ?>" href="<?php echo e(route('website.privacy')); ?>">Privacy & policy</a>
                     </li>
                     <li class="nav-item me-5">
                        <a class="nav-link p-0 text-white <?php echo e(request()->is('/term') == "term" ? 'active' : ''); ?>" href="<?php echo e(route('website.term')); ?>">Term & condition</a>
                     </li>
                     <li class="nav-item me-5">
                        <a class="nav-link p-0 text-white  <?php echo e(request()->is('help') == "/" ? 'active' : ''); ?>" href="<?php echo e(route('website.help.view')); ?>">Help</a>
                        </li>
                  </ul>
                  <?php if(Auth::user()): ?>
...
<?php /**PATH /var/www/html/restaurant-pos-backend/resources/views/website/include/header.blade.php ENDPATH**/ ?>