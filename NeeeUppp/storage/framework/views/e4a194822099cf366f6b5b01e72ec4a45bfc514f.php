        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped" id="branch">
                <thead>
                  <tr>
        ...
        <div class="modal-body">
          <form class="store_branch" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  <input type="number" step="any" min="0" class="form-control" placeholder="Delivery Fee" name="delivery_fee">
                </div>
            </div>
          ...
          <form class="edit_branch" method="POST">
            <div class="form-group">
              ...
              <div class="form-group">
                  <label>Phone:</label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Phone" name="phone" id="edit_phone">
                  </div>
              </div>
              <div class="form-group">
                  <label>Address:</label>
              ...
              <div class="form-group">
                  <label>Delivery Fee:</label>
                  <div class="input-group">
                    <input type="number" step="any" min="0" class="form-control" placeholder="Delivery Fee" name="delivery_fee" id="edit_delivery_fee">
                  </div>
              </div>
...
<script>
  ...
  var tables = $('#branch').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      url: "<?php echo e(route('admin.branch.branch_ajax_list')); ?>",
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/restaurant-pos-backend/resources/views/admin/branches/index.blade.php ENDPATH**/ ?>