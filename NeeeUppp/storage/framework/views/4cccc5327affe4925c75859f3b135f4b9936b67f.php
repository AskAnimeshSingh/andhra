...
<section class="section">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped" id="child_category">
                <thead>
                  <tr>
          ...
          <form class="store_cate" method="POST">
            <div class="form-group">
              ...
              <div class="input-group">
                type="text" class="form-control" placeholder="Category" name="category" id="category">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <select type="text" class="form-control" placeholder="Sub Category" name="sub_category" id="sub_category_show">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Child Category" name="child_category">
              </div>
            </div>
            <div class="form-group">
              <label>Icon</label>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModal">Edit Child Category</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form class="edit_cate" method="POST">
            <div class="form-group">
              <label>Category Name:</label>
              <div class="input-group">
                <select type="text" class="form-control" placeholder="Category" name="category" id="parent_cate">
                  <option value="">Select Category</option>
                  <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($item->id); ?>"><?php echo e($item->cate_name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
              <label>Sub Category Name:</label>
              <div class="input-group">
                <select type="text" class="form-control" placeholder="Sub Category" name="sub_category" id="edit_sub_category_show">
            ...
            <div class="form-group">
              <label>Child Category Name:</label>
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Child Category" name="child_category" id="edit_cate">
              </div>
            </div>
            <div class="form-group">
              <label>Icon</label>
...
<script>
  ...
  $("body").on("submit", ".store_cate", function(e) {
    ...
    $.ajax({
      url: "<?php echo e(route('admin.child_category.store')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
      ...
      success: function(result) {
        if (result.status) {
          ...
          $(".store_cate")[0].reset();
          $('#child_category').DataTable().ajax.reload(null, false);
  ...
  var tables = $('#child_category').DataTable({
    "processing": true,
    pageLength: 10,
    "serverSide": true,
    "ajax": {
      url: "<?php echo e(route('admin.child_category_ajax_list')); ?>",
  ...
  $("body").on("click", ".editCategory", function(e) {
    ...
    var id        = $(this).data('id');
    var parent_id = $(this).data('cate_id');
    var sub_cate  = $(this).data('sub_cate');
    var sub_name  = $(this).data('sub_name');

    $("#edit_cate").val(name)
    $('#cateid').val(id);
    $('#parent_cate').val(parent_id);
    $('#edit_sub_category_show').html('<option value="' + sub_cate + '">' + sub_name + '</option>');
    $('#oldicon').val(img);
  ...
  $("body").on("submit", ".edit_cate", function(e) {
    ...
    fd.append('_token', "<?php echo e(csrf_token()); ?>");
    $.ajax({
      url: "<?php echo e(route('admin.child_category.update')); ?>",
      type: "POST",
      data: fd,
      dataType: 'json',
      processData: false,
  ...
  $("body").on("click", ".statusVerifiedClick", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.child_category.status')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
  ...
  $("body").on("click", ".category-delete", function(e) {
    ...
    $.confirm({
      ...
      buttons: {
        yes: function() {
          $.ajax({
              url: "<?php echo e(route('admin.child_category.destroy')); ?>",
              type: 'POST',
              data: fd,
              dataType: "JSON",
              contentType: false,
  ...
  $('#category , #parent_cate').on('change', function(e) {
    let fd = new FormData();
    var cateid = $(this).val();
    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        $('#sub_category_show').html(datas);
        $('#edit_sub_category_show').html(datas);
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/restaurant-pos-backend/resources/views/admin/child_category/index.blade.php ENDPATH**/ ?>