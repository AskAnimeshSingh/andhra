...
Route::get('/login/{branch_id}/{table_id}', [Login::class, 'index'])->name('website.login');
Route::get('/opt/{id}/{branch_id}/{table_id}', [Login::class, 'opt_view'])->name('website.otp');
...
//reservation link
Route::get('/reservation-index', [Menu::class, 'reservation_index'])->name('website.reservation.index');
Route::get('/reservation-page/{id}', [Menu::class, 'reservationPage'])->name('website.reservation.page');
// Route for Help
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('pos-detail/{branch_id}/{table_id}', [Pos::class, 'index'])->name('website.pos_detail');
    ...
    Route::post('check_redeem', [Pos::class, 'check_redeem'])->name('website.check_redeem');
    ...
    Route::get('order_history/{branch_id?}/{table_id?}', [Pos::class, 'order_history'])->name('website.order_history');
